...
class PermissionsDbSeeder extends Seeder
{
    ...
    public function run()
    {
        $permissions_array = [
            ...
            "Can add answers to question for he or she added","Can delete questions","Can edit questions","Can view questions","Can delete notes",
            ...
            "Can assign permissions to a role","Can delete a role"
        ];
