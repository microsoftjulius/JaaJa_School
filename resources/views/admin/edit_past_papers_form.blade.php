                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="card card-default">
                                            <div class="card-header text-center">Fill this form to make an edit to the past paper</div>
                                            <div class="card-body">
                                                <form action="/update-past-paper/{{ $past_paper_id }}">
                                                    <div class="form-group">
                                                        <div class="col-lg-12">
                                                            <label for="class">Choose the Class:</label>
                                                            <input list="class" name="class_name" id="classes"  class="form-control" autocomplete="off" value="{{ $class_name }}" required>
                                                            <datalist id="class">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-lg-12">
                                                            <label for="class">Choose the Subject:</label>
                                                            <input list="subject" name="subject_name" id="subjects"  class="form-control" autocomplete="off" value="{{ $subject }}" required>
                                                            <datalist id="subject">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <input name="year" class="form-control" autocomplete="off" value="{{ $year }}" required>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-12 text-center">
                                                            <button class="btn btn-sm btn-success" type="submit"><i class="fa fa-save"></i> Save</button>
                                                            <a href="/get-past-papers"><button class="btn btn-sm btn-info" type="button"><i class="fa fa-arrow-left"></i> Back</button></a>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
