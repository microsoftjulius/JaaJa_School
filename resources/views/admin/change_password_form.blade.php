                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="card card-default">
                                            <div class="card-header text-center">To change the password, fill this form</div>
                                            <div class="card-body">
                                                <form action="/update-password" method="GET">
                                                    <div class="form-group">
                                                        <label>Current Password</label>
                                                        <input class="form-control" type="password" autocomplete="off"  name="current_password">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>New Password</label>
                                                        <input class="form-control" type="password" autocomplete="off"  name="new_password">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Confirm Password</label>
                                                        <input class="form-control" type="password" autocomplete="off"  name="confirm_password">
                                                    </div>
                                                    <div class="row">
