                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">A table showing past papers for a class</div>
                            </div>
                            <div class="card-body">
                            <table class="table table-striped my-4 w-100" id="datatable2">
                                ...
                                <tbody>
                                    @foreach ($class_past_papers as $id => $class_past_paper)
                                    <tr class="gradeX">
                                        <td>{{ $id + 1 }}</td>
                                        <td>{{ $class_past_paper->subject }}</td>
                                        <td>{{ $class_past_paper->class }}</td>
                                        <td>{{ $class_past_paper->teachers_name }}</td>
                                        <td><a href="{{ asset('home_work/'.$class_past_paper->home_work) }}" target="_blank"><i class="fa fa-download"></i> download</a></td>
                                        <td>{{ $class_past_paper->created_at }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
