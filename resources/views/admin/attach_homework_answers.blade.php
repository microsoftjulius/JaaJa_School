                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="card card-default">
                                            <div class="card-header text-center">On this page, {{ auth()->user()->name  }} you are required to attach your homework answers</div>
                                            <div class="card-body">
                                                <form action="/answers-for-homework/{{ $home_work_id }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
