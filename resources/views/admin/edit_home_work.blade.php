                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="card card-default">
                                            <div class="card-header text-center">To edit the name {{ $home_work[0]->subject }} of to a new name</div>
                                            <div class="card-body">
                                                <form action="/edit-home-work/{{ $home_work_id }}">
                                                    <div class="form-group">
                                                        <div class="col-lg-12">
                                                            <label for="class">Home Work For:</label>
                                                            <input list="subject" id="classes" class="form-control" autocomplete="off" 
                                                                value="{{ $home_work[0]->subject }}" name="subject">
                                                            <datalist id="subject">
