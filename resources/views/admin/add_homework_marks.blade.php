                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="card card-default">
                                            <div class="card-header text-center">Add Marks</div>
                                            <div class="card-body">
                                                <form action="/update-student-marks-for-homework/{{ $homework_id }}/for-student-/{{ $student_id }}" method="get" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-lg-12"><br>
                                                            <input type="number" name="marks" id="" class="form-control" /><br>
                                                        </div>
                                                    </div>
                                                    <div class="row">
