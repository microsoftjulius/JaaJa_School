                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="card card-default">
                                            <div class="card-header text-center">Once you make an update to the homework on this page, your pre-uploaded work will nolonger be used</div>
                                            <div class="card-body">
                                                <form action="/change-submited-answers-for-homework/{{ $home_work_id }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-lg-12"><br>
                                                            <input type="file" class="form-control dropzone mb-3 card d-flex flex-row justify-content-center flex-wrap"
                                                            id="dropzone-area" accept=".pdf" name="answers_pdf">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-12 text-center">
                                                            <button class="btn btn-sm btn-success" type="submit"><i class="fa fa-save"></i> Save</button>
                                                            <a href="/display-home-work"><button class="btn btn-sm btn-info" type="button"><i class="fa fa-arrow-left"></i> Back</button></a>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
