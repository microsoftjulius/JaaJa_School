                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="card card-default">
                                            <div class="card-header text-center">To edit the name of {{ $subject_name }} to a new name</div>
                                            <div class="card-body">
                                                <form action="/edit-subject/{{ $subject_id }}">
                                                    <div class="form-group">
                                                        <label>New Class Name</label>
                                                        <input class="form-control" type="text" autocomplete="off" value="{{ $subject_name }}" name="subject">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-12 text-center">
                                                            <button class="btn btn-sm btn-success" type="submit"><i class="fa fa-save"></i> Save</button>
                                                            <a href="/display-subjects"><button class="btn btn-sm btn-info" type="button"><i class="fa fa-arrow-left"></i> Back</button></a>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
