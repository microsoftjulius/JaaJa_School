                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="card card-default">
                                            <div class="card-header text-center">To edit the class where this home work should be, fill in this form</div>
                                            <div class="card-body">
                                                <form action="/edit-questions/{{ $class_id }}">
                                                    <div class="form-group">
                                                        <div class="col-lg-12">
                                                            <label for="class">Choose the Class:</label>
                                                            <input list="class" name="class_name" id="classes" class="form-control" autocomplete="off" value="{{ $class_name }}" name="class_name">
                                                            <datalist id="class">
