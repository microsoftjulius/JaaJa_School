                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="card card-default">
                                            <div class="card-header text-center">To edit the name of the class whose notes are this, select the name here</div>
                                            <div class="card-body">
                                                <form action="/edit-notes/{{ $notes_id }}">
                                                    <div class="form-group">
                                                        <div class="col-lg-12">
                                                            <label for="class">Choose the Class:</label>
                                                            <input list="class" name="class_name" id="classes" value="{{ $class_name }}" class="form-control" autocomplete="off">
                                                            <datalist id="class">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 text-center">
                                                            ...
                                                            <a href="/display-notes"><button class="btn btn-sm btn-info" type="button"><i class="fa fa-arrow-left"></i> Back</button></a>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
