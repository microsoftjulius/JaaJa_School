                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">A table showing notes for a class</div>
                            </div>
                            <div class="card-body">
                            <table class="table table-striped my-4 w-100" id="datatable2">
                                ...
                                <tbody>
                                    @foreach ($class_notes as $id => $class_note)
                                    <tr class="gradeX">
                                        <td>{{ $id + 1 }}</td>
                                        <td>{{ $class_note->subject }}</td>
                                        <td>{{ $class_note->class }}</td>
                                        <td>{{ $class_note->teachers_name }}</td>
                                        <td><a href="{{ asset('notes/'.$class_note->notes) }}" target="_blank"><i class="fa fa-download"></i> download</a></td>
                                        <td>{{ $class_note->created_at }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
