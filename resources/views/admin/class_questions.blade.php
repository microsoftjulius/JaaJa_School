                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">A table showing Questions for a class</div>
                            </div>
                            <div class="card-body">
                            <table class="table table-striped my-4 w-100" id="datatable2">
                                ...
                                <tbody>
                                    @foreach ($class_questions as $id => $class_question)
                                    <tr class="gradeX">
                                        <td>{{ $id + 1 }}</td>
                                        <td>{{ $class_question->subject }}</td>
                                        <td>{{ $class_question->class }}</td>
                                        <td>{{ $class_question->teachers_name }}</td>
                                        <td><a href="{{ asset('questions/'.$class_question->questions_pdf) }}" target="_blank"><i class="fa fa-download"></i> download</a></td>
                                        <td>{{ $class_question->created_at }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
